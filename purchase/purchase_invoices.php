    ...
    <script>
        ...
        const PurchaseManager = {
            ...
            createInvoiceRow(invoice) {
                ...
                const returnsValue = invoice.returns_value || 0;
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <div style="font-size: 13px;">
                            ...
                            <div class="text-muted">الكمية: ${totalQuantity.toFixed(2)}</div>
                            ${invoice.total_qty_received ? `
                                <div class="text-success" style="font-size: 12px;">
                                    المستلمة: ${invoice.total_qty_received.toFixed(2)}
                                </div>
                            ` : ''}
                        </div>
                    </td>
                    ...
                    <td>
                        ${returnsValue > 0 ? 
                            `<span class="badge badge-returned">${UIManager.formatCurrency(returnsValue)}</span>` : 
