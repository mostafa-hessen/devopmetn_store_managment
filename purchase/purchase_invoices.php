    ...
    <head>
        ...
        <style>
            ...
            .smart-filter-tag .remove-btn:hover {
                background: #5c6bc0;
                color: white;
            }
            ...
            .stats-badge.info { background: #0b84ff; }
            .stats-badge.warning { background: #f59e0b; }
            .stats-badge.success { background: #10b981; }
    ...
    <body>
        <div class="app-container m-2">
            ...
            <main class="main-content-container">
                ...
                <!-- ==================== SMART FILTERS ==================== -->
                <div class="smart-filters-container hidden" id="smartFiltersContainer">
                    <div id="activeFilters">
                        <!-- الفلاتر النشطة ستظهر هنا -->
                    </div>
                    <button class="reset-filters-btn" onclick="FilterManager.resetAllFilters()">
                ...
                <div id="invoicesTab" class="tab-content">
                    ...
                    <div class="quick-actions">
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('today', 'invoices')">
                            <i class="fas fa-calendar-day"></i>
                            اليوم
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('week', 'invoices')">
                            <i class="fas fa-calendar-week"></i>
                            هذا الأسبوع
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('month', 'invoices')">
                            <i class="fas fa-calendar-alt"></i>
                            هذا الشهر
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('year', 'invoices')">
                            <i class="fas fa-calendar"></i>
                            هذا العام
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('pending', 'invoices')">
                            <i class="fas fa-clock"></i>
                            قيد الانتظار
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('received', 'invoices')">
                    ...
                    <div class="filters-card advanced-filter">
                        <div class="filter-grid">
                            ...
                            <div class="filter-group">
                                <label><i class="fas fa-calendar-alt"></i> السنة</label>
                                <div class="year-filter-group">
                                    <select class="year-filter-select" id="yearFilter" onchange="FilterManager.updateDateFromYear()">
                            ...
                            <div class="filter-group">
                                ...
                                <div class="search-input-with-icon">
                                    <input type="date" class="form-input" id="dateFromFilter"
                                        onchange="FilterManager.onDateChange('invoices')">
                                </div>
                            </div>
                            ...
                            <div class="filter-group">
                                ...
                                <select class="form-select" id="statusFilter" onchange="FilterManager.onFilterChange('invoices')">
                            ...
                            <div class="filter-actions">
                                ...
                                <button class="btn btn-light" onclick="FilterManager.resetTabFilters('invoices')">
                                    <i class="fas fa-redo"></i>
                                    إعادة تعيين
                                </button>
                            </div>
                ...
                <div id="returnsTab" class="tab-content hidden">
                    <!-- Quick Actions -->
                    <div class="quick-actions">
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('today', 'returns')">
                            <i class="fas fa-calendar-day"></i>
                            اليوم
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('week', 'returns')">
                            <i class="fas fa-calendar-week"></i>
                            هذا الأسبوع
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('month', 'returns')">
                            <i class="fas fa-calendar-alt"></i>
                            هذا الشهر
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('year', 'returns')">
                            <i class="fas fa-calendar"></i>
                            هذا العام
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('pending', 'returns')">
                            <i class="fas fa-clock"></i>
                            قيد الانتظار
                        </div>
                        <div class="quick-action-btn" onclick="FilterManager.setQuickFilter('completed', 'returns')">
                            <i class="fas fa-check-circle"></i>
                            مكتمل
                        </div>
                    </div>
                    ...
                    <div class="filters-card advanced-filter">
                        <div class="filter-grid">
                            <div class="filter-group">
                                ...
                                <div class="search-input-with-icon">
                                    <input type="text" class="form-input" id="returnSupplierNameFilter" 
                                        placeholder="اكتب للبحث عن مورد..."
                                        onkeyup="FilterManager.debouncedSearch('returns')">
                                    <i class="fas fa-search"></i>
                                </div>
                            </div>
                            <div class="filter-group">
                            ...
                            <div class="filter-group">
                                <label><i class="fas fa-hashtag"></i> رقم المرتجع</label>
                                <div class="search-input-with-icon">
                                    <input type="number" class="form-input" id="returnNumberFilter" 
                            ...
                            <div class="filter-group">
                                <label><i class="fas fa-calendar-alt"></i> السنة</label>
                                <div class="year-filter-group">
                                    <select class="year-filter-select" id="returnYearFilter" onchange="FilterManager.updateReturnDateFromYear()">
                                        <option value="">كل السنوات</option>
                                        <!-- سيتم تعبئته بواسطة JavaScript -->
                                    </select>
                                </div>
                            ...
                            <div class="filter-group">
                                ...
                                <div class="search-input-with-icon">
                                    <input type="date" class="form-input" id="returnDateFrom"
                                        onchange="FilterManager.onDateChange('returns')">
                                </div>
                            </div>
                            <div class="filter-group">
                                <label><i class="fas fa-calendar-alt"></i> إلى تاريخ</label>
                            ...
                            <div class="filter-group">
                                ...
                                <select class="form-select" id="returnTypeFilter" onchange="FilterManager.onFilterChange('returns')">
                            ...
                            <div class="filter-group">
                                ...
                                <select class="form-select" id="returnStatusFilter" onchange="FilterManager.onFilterChange('returns')">
                                    <option value="">كل الحالات</option>
                            ...
                            <div class="filter-actions">
                                ...
                                <button class="btn btn-light" onclick="FilterManager.resetTabFilters('returns')">
                                    <i class="fas fa-redo"></i>
                                    إعادة تعيين
                                </button>
                            </div>
                    ...
                    <div class="stats-grid" id="returnsSummaryStats">
                        <!-- سيتم تعبئته بواسطة JavaScript -->
                    </div>
...
const RETURN_TYPES_Colors = {
    supplier_return: '#28a745', // أخضر → إرجاع للمورد
    damaged: '#dc3545',         // أحمر → تلف في المخزن
    expired: '#ffc107',         // أصفر → منتهي الصلاحية
    other: '#17a2b8'            // أزرق → أخرى
};
            ...
            const FilterManager = {
                ...
                generateYearOptions() {
                    ...
                    const startYear = 2020; // يمكن تغيير هذا حسب حاجتك
                    ...
                    // للمرتجعات
                    const returnYearSelect = document.getElementById('returnYearFilter');
                    if (returnYearSelect) {
                        returnYearSelect.innerHTML = '<option value="">كل السنوات</option>';
                        for (let year = currentYear; year >= startYear; year--) {
                            returnYearSelect.innerHTML += `<option value="${year}">${year}</option>`;
                        }
                    }
                },
                ...
                setDefaultDates() {
                    ...
                    // بالنسبة للفواتير: من أول العام إلى اليوم
                    const firstDayOfYear = new Date(currentYear, 0, 1);
                    
                    document.getElementById('dateFromFilter').value = this.formatDateForInput(firstDayOfYear);
                    document.getElementById('dateToFilter').value = this.formatDateForInput(today);
                    
                    // بالنسبة للمرتجعات
                    document.getElementById('returnDateFrom').value = this.formatDateForInput(firstDayOfYear);
                    document.getElementById('returnDateTo').value = this.formatDateForInput(today);
                    
                    // تحديث الفلاتر النشطة
                    this.updateActiveFilters('invoices');
                },
                ...
                setupEventListeners() {
                    // إضافة active class للـ quick actions
                    document.querySelectorAll('.quick-action-btn').forEach(btn => {
                        btn.addEventListener('click', function() {
                            // إزالة active من جميع الأزرار في نفس الـ container
                            const container = this.closest('.quick-actions');
                            container.querySelectorAll('.quick-action-btn').forEach(b => {
                ...
                setQuickFilter(type, tab) {
                    ...
                    if (tab === 'invoices') {
                        ...
                        document.getElementById('returnDateFrom').value = this.formatDateForInput(startDate);
                        document.getElementById('returnDateTo').value = this.formatDateForInput(endDate);
                    }
                ...
                updateReturnDateFromYear() {
                    const yearSelect = document.getElementById('returnYearFilter');
                    const year = yearSelect.value;
                ...
                onDateChange(tab) {
                    // إخفاء فلتر السنة عند تغيير التاريخ يدوياً
                    if (tab === 'invoices') {
                        document.getElementById('yearFilter').value = '';
                    } else {
                        document.getElementById('returnYearFilter').value = '';
                    }
                ...
                updateActiveFilters(tab) {
                    const filtersContainer = document.getElementById('smartFiltersContainer');
                    const activeFiltersDiv = document.getElementById('activeFilters');
                    
                    if (!filtersContainer || !activeFiltersDiv) return;
                    
                    this.activeFilters[tab] = this.getCurrentFilters(tab);
                    
                    // عرض الفلاتر النشطة فقط إذا كان هناك فلتر نشط
                    const hasActiveFilters = Object.values(this.activeFilters[tab]).some(value => 
                        value !== '' && value !== null && value !== undefined
                    );
                    
                    if (hasActiveFilters) {
                        filtersContainer.classList.remove('hidden');
                        activeFiltersDiv.innerHTML = this.renderActiveFilters(tab);
                    } else {
                ...
                getCurrentFilters(tab) {
                    ...
                    if (tab === 'invoices') {
                        ...
                        filters.supplier = document.getElementById('returnSupplierNameFilter').value;
                        filters.originalInvoiceId = document.getElementById('returnOriginalInvoiceFilter').value;
                        filters.returnNumber = document.getElementById('returnNumberFilter').value;
                        filters.dateFrom = document.getElementById('returnDateFrom').value;
                        filters.dateTo = document.getElementById('returnDateTo').value;
                        filters.returnType = document.getElementById('returnTypeFilter').value;
                        filters.returnStatus = document.getElementById('returnStatusFilter').value;
                        filters.year = document.getElementById('returnYearFilter').value;
                    }
                ...
                renderActiveFilters(tab) {
                    const filters = this.activeFilters[tab] || {};
                    let html = '';
                    
                    Object.entries(filters).forEach(([key, value]) => {
                        if (value && value !== '') {
                            const label = this.getFilterLabel(key, value, tab);
                            html += `
                                <div class="smart-filter-tag">
                                    <span>${label}</span>
                                    <button class="remove-btn" onclick="FilterManager.removeFilter('${key}', '${tab}')">
                                        ×
                                    </button>
                                </div>
                            `;
                ...
                getFilterLabel(key, value, tab) {
                    const labels = {
                        ...
                        dateTo: `إلى: ${this.formatDisplayDate(value)}`,
                        status: `الحالة: ${STATUS_LABELS[value] || value}`,
                        returnType: `النوع: ${RETURN_TYPES[value] || value}`,
                        returnStatus: `الحالة: ${RETURN_STATUS_LABELS[value] || value}`,
                        year: `السنة: ${value}`
                    };
                    ...
                    if (tab === 'invoices') {
                        switch(filterKey) {
                            ...
                            case 'dateFrom':
                                ...
                                break;
                            case 'dateTo':
                                document.getElementById('dateToFilter').value = this.formatDateForInput(new Date());
                                break;
                            case 'status':
                        ...
                        switch(filterKey) {
                            ...
                            case 'dateFrom':
                                ...
                                break;
                            case 'dateTo':
                                document.getElementById('returnDateTo').value = this.formatDateForInput(new Date());
                                break;
                            case 'returnType':
                ...
                resetTabFilters(tab) {
                    if (tab === 'invoices') {
                        ...
                        // إعادة التواريخ إلى أول العام الحالي
                        const currentYear = new Date().getFullYear();
                        const firstDayOfYear = new Date(currentYear, 0, 1);
                        document.getElementById('dateFromFilter').value = this.formatDateForInput(firstDayOfYear);
                        document.getElementById('dateToFilter').value = this.formatDateForInput(new Date());
                        
                        // إزالة active من quick actions
            ...
            const APIManager = {
                ...
                async fetchReturns(filters = {}) {
                    ...
                    if (filters.returnNumber) params.return_out_id = filters.returnNumber;
            ...
            const UIManager = {
                ...
                switchTab(tabName) {
                    ...
                    // إظهار/إخفاء الفلاتر الذكية حسب التبويب
                    FilterManager.updateActiveFilters(tabName);
                },
                ...
                updateSummaryStats(stats, containerId, type = 'invoices') {
                    const container = document.getElementById(containerId);
                    if (!container) return;
                    ...
                    if (type === 'invoices') {
                        const displayedSum = parseFloat(stats.displayed_sum) || 0;
                        const displayedReturnsSum = parseFloat(stats.displayed_returns_sum) || 0;
                        const netPurchases = displayedSum - displayedReturnsSum;
                        ...
                        html = `
                            <div class="stat-card">
                                ...
                                <div class="statistics-notes">
                                    ...
                                    تشمل الفواتير غير الملغاة فقط
                                </div>
                            </div>
                            <div class="stat-card">
                                <h3>إجمالي المشتريات المعروضة</h3>
                                <div class="stat-value">${this.formatCurrency(displayedSum)}</div>
                                <div class="statistics-notes">
                                    <i class="fas fa-info-circle"></i>
                                    القيمة بناءً على الفلاتر المطبقة
                                </div>
                            </div>
                            <div class="stat-card">
                                <h3>إجمالي المرتجعات المعروضة</h3>
                                <div class="stat-value">${this.formatCurrency(displayedReturnsSum)}</div>
                                <div class="statistics-notes">
                                    <i class="fas fa-info-circle"></i>
                                    المرتجعات المرتبطة بالفواتير المعروضة
                                </div>
                            </div>
                            <div class="stat-card">
                                <h3>صافي المشتريات</h3>
                                <div class="stat-value">${this.formatCurrency(netPurchases)}</div>
                                <div class="statistics-notes">
                                    <i class="fas fa-info-circle"></i>
                                    إجمالي المشتريات - إجمالي المرتجعات
                                </div>
                            </div>
                        `;
                    } else {
                        html = `
                            <div class="stat-card">
                                ...
                                <div class="statistics-notes">
                                    <i class="fas fa-info-circle"></i>
                                    تشمل المرتجعات غير الملغاة فقط
                                </div>
                            </div>
                            <div class="stat-card">
            ...
            const PurchaseManager = {
                ...
                async loadStatistics() {
                    try {
                        ...
                        if (result.success) {
                            ...
                            // تحديث عدد الفواتير في الـ badge
                            const badge = document.getElementById('invoicesCountBadge');
                            if (badge) {
                                const totalInvoices = result.statistics.by_status?.reduce((sum, item) => 
                                    sum + (item.status !== 'cancelled' ? item.count : 0), 0) || 0;
                                badge.textContent = totalInvoices;
                            }
                        }
                    } catch (error) {
                ...
                renderStatsCards(stats) {
                    ...
                    // الحصول على إحصائيات المرتجعات من API منفصل
                    this.loadReturnsStatistics().then(returnsStats => {
                        if (returnsStats) {
                            totalReturns = returnsStats.total?.value || 0;
                        }
                        ...
                        container.innerHTML = `
                            <div class="stats-card-enhanced">
                                ...
                                <div style="font-size: 12px; opacity: 0.8;">
                                    <i class="fas fa-info-circle"></i> الفواتير النشطة فقط
                                </div>
                            </div>
                            ...
                            <div class="stats-card-enhanced stats-card-warning">
                                ...
                                <div style="font-size: 12px; opacity: 0.8;">
                                    <i class="fas fa-info-circle"></i> إجمالي المرتجعات المعتمدة
                                </div>
                            </div>
                ...
                async loadReturnsStatistics() {
                    try {
                        const result = await APIManager.fetchReturnsStatistics();
                        if (result.success) {
                            return result.statistics;
                        }
                    } catch (error) {
                        console.error('Error loading returns statistics:', error);
                    }
                    return null;
                },
                ...
                async loadInvoices() {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            UIManager.updateSummaryStats(result.statistics, 'invoicesSummaryStats', 'invoices');
                ...
                createInvoiceRow(invoice) {
                    ...
                    const totalQuantity = invoice.total_qty || 0;
                    ...
                    row.innerHTML = `
                        ...
                        <td>
                            <div style="font-size: 13px;">
                                <div>${totalQuantity.toFixed(2)} كمية</div>
                            </div>
                        </td>
                        <td class="fw-bold text-right">${UIManager.formatCurrency(invoice.total_amount)}</td>
                        <td>
                            ${returnsCount > 0 ? 
                                `<span class="badge badge-returned">${returnsCount.toFixed(2)}</span>` : 
                ...
                resetFilters() {
                    FilterManager.resetTabFilters('invoices');
                },
            ...
            const ReturnManager = {
                ...
                async loadReturns() {
                    ...
                    try {
                        ...
                        const filters = {
                            ...
                            returnNumber: document.getElementById('returnNumberFilter').value,
                        ...
                        if (result.success) {
                            ...
                            UIManager.updateSummaryStats(result.statistics, 'returnsSummaryStats', 'returns');
                            
                            // تحديث عدد المرتجعات في الـ badge
                ...
                createReturnRow(ret) {
                    ...
                    const returnTypeBadge= this.getReturnTypeBadge(ret.return_type);
             ...
             getReturnTypeBadge(type) {
    switch(type) {
        case 'supplier_return':
            return '<span class="badge badge-supplier_return">إرجاع للمورد</span>';
        case 'damaged':
            return '<span class="badge badge-damaged">تلف في المخزن</span>';
        case 'expired':
            return '<span class="badge badge-expired">منتهي الصلاحية</span>';
        case 'other':
            return '<span class="badge badge-other">أخرى</span>';
        default:
...
,
                ...
                resetFilters() {
                    FilterManager.resetTabFilters('returns');
                },
    ...
    tbody.innerHTML = ''; // مسح القديم قبل الإضافة
                ...
                async submitReturn() {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            await PurchaseManager.loadStatistics()
