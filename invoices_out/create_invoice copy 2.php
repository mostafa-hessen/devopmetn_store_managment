    ...
    paymentNotes: '', // 
        ...
        <button class="btn ghost fifo-btn" data-index="${index}">تفاصيل FIFO</button>
            ...
            `;
                    ...
                    //     }
                    // },
                    // في UI.updatePaymentSection، نعدل:
                    updatePaymentSection() {
                        if (!DOM.paymentTotal || !DOM.paymentPaid || !DOM.paymentRemaining || !DOM.partialPaymentSection) return;
                        ...
                        if (paymentStatus.value === 'partial') {
                            ...
                            // إذا كان مدفوع بالكامل، أضف دفعة واحدة بالقيمة الكاملة
    ...
    `;
                    ...
                    async processInvoice(shouldPrint = false) {
                        ...
                        const invoiceData = {
                            ...
                            notes: '', // يمكن إضافة حقل للملاحظات إذا لزم
                            csrf_token: AppState.csrfToken
                        };
...
async processInvoice(shouldPrint = false) {
    ...
    const invoiceData = {
        ...
        discount_type: AppState.discount.type,
        discount_value: AppState.discount.value,
        notes: AppState.invoiceNotes, // ملاحظات الفاتورة
...
resetInvoice() {
    ...
    const paymentNotesTextarea = document.getElementById('payment-notes-input');
    ...
    // إغلاق نموذج النجاح إذا كان مفتوحاً
    const successModal = document.getElementById('success-modal');
                    ...
                    setupModalEvents() {
                        ...
                        if (DOM.clearBtn) {
                            DOM.clearBtn.addEventListener('click', () => {
                                // if (confirm('هل أنت متأكد من تفريغ جميع بنود الفاتورة؟')) {
