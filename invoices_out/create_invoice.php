                ...
                <div class="partial-payment" id="partial-payment-section" style="display: none;">
                    <div class="payment-amounts">
                        ...
                        <div class="payment-amount">
                            ...
                            <div class="value" id="payment-paid_amount">٠٫٠٠ ج.م</div>
                        </div>
                        <div class="payment-amount">
...
<script>
    ...
    const UI = {
        ...
        updatePaymentSection() {
            if (!DOM.paymentTotal || !DOM.paymentPaidAmmount || !DOM.paymentRemaining) return;
            ...
            DOM.paymentPaidAmmount.textContent = Helpers.formatCurrency(paidAmount);
            // console.log(DOM.paymentPaid.textContent );
...
async confirmFullPayment() {
    ...
    const notes = document.getElementById('partial-payment-notes')?.value.trim() || '';
