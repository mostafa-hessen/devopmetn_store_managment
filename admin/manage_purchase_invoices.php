                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <?php endif; ?>
                      ...
                      <?php if ($inv['status'] === 'fully_received'): ?>
        <button onclick="openReturnModal(<?php echo $inv['id']; ?>)" 
                class="btn btn-danger btn-sm">
            إنشاء مرتجع
        </button>
        <a href="view_purchase_returns.php?invoice_id=<?php echo $inv['id']; ?>" 
...
<div id="returnModal" class="modal">
    <div class="modal-content">
        <h3>إنشاء مرتجع للمورد</h3>
        <form id="returnForm">
            <input type="hidden" name="purchase_invoice_id" value="">
            <input type="hidden" name="csrf_token" value="">
            
            <div class="form-group">
                <label>نوع الإرجاع:</label>
                <select name="return_type" required>
                    <option value="partial_defective">إرجاع منتجات معيبة</option>
                    <option value="partial_excess">إرجاع فائض كمية</option>
                    <option value="wrong_item">إرجاع منتج خاطئ</option>
            ...
            <!-- قائمة الدفعات للإرجاع -->
            <div id="batchesList">
                <!-- سيتم تعبئتها بالجافاسكريبت -->
            </div>
            
            <button type="submit" class="btn btn-primary">إنشاء طلب إرجاع</button>
        </form>
    </div>
</div>
