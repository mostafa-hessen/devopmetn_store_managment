...
const UIManager = {
  ...
  setupEventListeners() {
    ...
    document
      .getElementById("workOrderSearchFilter")
      .addEventListener("input", (e) => {
        AppData.activeFilters.workOrderSearch = e.target.value;
        this.applyFilters();
      });
    ...
    document
      ...
      .forEach((closeBtn) => {
        closeBtn.addEventListener("click", function () {
          ...
          } else if (filterKey === "workOrderSearch") {
            document.getElementById("workOrderSearchFilter").value = "";
          }
